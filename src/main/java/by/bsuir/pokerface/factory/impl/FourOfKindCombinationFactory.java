...
public class FourOfKindCombinationFactory implements CombinationFactory {
    private static final int DISTINCT_CARD_COUNT = 4;
    private static final int KICKER_COUNT = 1;
    private static final int CARD_FREQUENCY = 4;
    ...
    public Optional<Combination> createCombination(List<Card> cards) {
        ...
        return Optional.of(new Combination(CombinationType.FOUR_OF_A_KIND, strength));
    }
}
